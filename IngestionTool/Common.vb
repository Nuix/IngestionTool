...
Public Class Common
    ...
    Sub subSourceDirSearch(ByVal sDir As String, ByRef iTotalNumberOfSourceDataFiles As Integer, ByRef dblTotalSizeOfSourceData As Double, ByVal sSourceDataType As String)
        ...
        Catch ex As Exception
            Logger(psIngestionLogFile, "Error 7 - Directory Search" & ex.ToString)
        End Try

    End Sub

    Public Function BuildSQLiteRubyScript(ByVal sSQLiteDBLocation As String) As Boolean
        Dim SQLiteRuby As StreamWriter
        BuildSQLiteRubyScript = False
        ...
        SQLiteRuby.Close()
        BuildSQLiteRubyScript = True

    End Function


    Public Function BuildSQLiteDatabaseScript(ByVal sSQLiteDBLocation As String) As Boolean
        Dim SQLiteDatabaseScript As StreamWriter

        BuildSQLiteDatabaseScript = False
        ...
        BuildSQLiteDatabaseScript = True
    End Function

    Public Sub Logger(ByVal sLogFileName As String, ByVal sLogMessage As String)
        Dim IngestionLog As StreamWriter

        If (File.Exists(sLogFileName)) Then
            IngestionLog = File.AppendText(sLogFileName)
            IngestionLog.WriteLine(DateTime.Now.ToString("yyyy-MM-dd hh-mm-ss") & " - " & sLogMessage)

            IngestionLog.Close()
        Else
            Try
                IngestionLog = New StreamWriter(sLogFileName)
                IngestionLog.WriteLine(DateTime.Now.ToString("yyyy-MM-dd hh-mm-ss") & " - " & sLogMessage)
                IngestionLog.Close()
            Catch ex As Exception
    ...
    Public Function BuildIngestionCustodianNuixFiles(ByVal asCustodianInfo() As String, ByRef sPSTDirectory As String, ByVal sTimeout As String, ByVal sNuixAppMemory As String, ByRef lstCurrentCustodianFolder As List(Of String), ByVal dblPSTSourceSize As Double, ByVal sDestinationFolder As String, ByVal sDestinationRoot As String, ByVal sDestinationSMTPAddress As String) As Boolean
        Dim bStatus As Boolean
        ...
        BuildIngestionCustodianNuixFiles = False
        ...
        My.Computer.FileSystem.CreateDirectory(eMailArchiveMigrationManager.NuixFilesDir & "\EWS Ingestion\Nuix Files\" & asCustodianInfo(0))
        ...
        bStatus = dbService.GetUpdatedIngestionDBInfo(eMailArchiveMigrationManager.SQLiteDBLocation, asCustodianInfo(0), "CaseDirectory", sNuixCase, "TEXT")
        ...
        bStatus = common.BuildIngestionBatchFiles(asCustodianInfo(0), sProcessingFilesDirectory & "\" & asCustodianInfo(0) & "\", sRubyFileName, sMappingFileName, sNuixAppMemory, sLogDirectory, sOutputDirectory)
        ...
        bStatus = BuildIngestionJSonFile(asCustodianInfo(0), sJSonFileName, sRubyFilePSTLocation, eMailArchiveMigrationManager.O365MemoryPerWorker, eMailArchiveMigrationManager.NuixWorkers, eMailArchiveMigrationManager.NuixCaseDir, sRubyFilePSTLocation, sDestinationFolder, sDestinationRoot, sDestinationSMTPAddress, dblPSTSourceSize, sPSTDirectory)
        bStatus = BuildIngestionCustodianMappingFile(asCustodianInfo(0), sMappingFileName, sDestinationFolder, sDestinationRoot, sDestinationSMTPAddress, dblPSTSourceSize, sPSTDirectory)

        lstCurrentCustodianFolder.Add(sPSTDirectory & "EWS Ingestion\Not Started\" & asCustodianInfo(0))
        asCustodianInfo = Nothing

        BuildIngestionCustodianNuixFiles = True
    End Function
    ...
    Private Function BuildIngestionCustodianMappingFile(ByVal sCustodianName As String, ByVal sMappingFileName As String, ByVal sDestinationFolder As String, ByVal sDestinationRoot As String, ByVal sDestinationSMTPAddress As String, ByVal dblPSTSourceSize As Double, ByVal sCustodianPSTPath As String) As Boolean
        ...
        BuildIngestionCustodianMappingFile = True
    End Function

    Public Function GetAllSummaryReportFiles(ByRef sSummaryReportFiles As String) As Boolean
        GetAllSummaryReportFiles = False
        ...
        sCustodianQuery = "select SummaryReportLocation from ewsingestionstats where SummaryReportLocation != ''"
        ...
        If dataReader.HasRows Then
            While dataReader.Read
                If sSummaryReportFiles = vbNullString Then
                    sSummaryReportFiles = dataReader.GetValue(0)
                Else
                    sSummaryReportFiles = sSummaryReportFiles & "," & dataReader.GetValue(0)
        ...
        End If
        Connection.Close()
        GetAllSummaryReportFiles = True
    End Function

    Public Function GetCompletedCustodianInfo(ByRef lstCustodianName As List(Of String), ByRef lstBytesUploaded As List(Of String), ByRef lstPercentCompleted As List(Of String)) As Boolean
        GetCompletedCustodianInfo = False
        ...
        sCustodianQuery = "SELECT CustodianName, BytesUploaded, PercentCompleted FROM ewsIngestionStats WHERE ProgressStatus = 'Completed'"
        ...
        End If
        Connection.Close()
        GetCompletedCustodianInfo = True
    End Function
    ...
    Public Function blnBuildCustodianNuixFiles(ByVal asCustodianInfo() As String, ByVal sNuixAppMemory As String, sDataOutputType As String) As Boolean
        ...
        bStatus = BuildEmailConversionBatchFiles(asCustodianInfo(0), eMailArchiveMigrationManager.NuixFilesDir & "\Email Conversion\Nuix Files\" & asCustodianInfo(0) & "\", sRubyFileName, sMappingFileName, sNuixAppMemory)
    ...
    Private Function BuildIngestionJSonFile(ByVal sCustodianName As String, ByVal sJSonFileName As String, sPSTLocation As String, ByVal sWorkerMemory As String, ByVal sWorkerCount As String, ByVal sCaseDir As String, ByVal sRubyFilePSTLocation As String, ByVal sDestinationFolder As String, ByVal sDestinationRoot As String, ByVal sDestinationSMTPAddress As String, ByVal dblPSTSourceSize As Double, ByVal sCustodianPSTPath As String) As Boolean
        BuildIngestionJSonFile = False
        ...
        BuildIngestionJSonFile = True

    End Function

    Public Function BuildEmailConversionBatchFiles(ByVal sCustodianName As String, ByVal sDirectoryName As String, ByVal sRubyFileName As String, ByVal sMappingFileName As String, ByVal sNuixAppMemory As String) As Boolean

        BuildEmailConversionBatchFiles = False
        ...
        BuildEmailConversionBatchFiles = True
    End Function
    ...
    Public Function BuildExtractionJSonFile(ByVal sJSonFileName As String, sSourceFolders As String, ByVal sEvidenceKeyStore As String, ByVal sEvidencePassword As String, ByVal sCaseName As String, ByVal sSourceSize As String, ByVal sMigrationType As String) As Boolean
        BuildExtractionJSonFile = False
        ...
        BuildExtractionJSonFile = True

    End Function

    Public Function BuildExtractionCustodianMappingFile(ByVal asCustodianInfo() As String, ByVal sMappingFileName As String, ByVal sOutputFormat As String) As Boolean
        BuildExtractionCustodianMappingFile = False

        Dim CustodianMappingFile As StreamWriter
        Dim sCustodianName As String
        Dim sCustodianPSTPath As String
        Dim dblPSTSize As Double

        sCustodianName = asCustodianInfo(0)
        sCustodianPSTPath = asCustodianInfo(1)
        dblPSTSize = CDbl(asCustodianInfo(2))

        CustodianMappingFile = New StreamWriter(sMappingFileName)

        CustodianMappingFile.WriteLine(sCustodianName & "," & sCustodianName & "." & sOutputFormat)

        CustodianMappingFile.Close()

        BuildExtractionCustodianMappingFile = True
    End Function
    ...
    Public Function blnGetSummaryReportInfo(ByVal sSummaryReport As String, ByRef sCustodianName As String, ByRef sItemsProcessed As String, ByRef sItemsExported As String, ByRef sItemsFailed As String, ByRef sItemsSkipped As String, ByRef sBytesUploaded As String, ByRef dStartDate As Date, ByRef dEndDate As Date) As Boolean
        ...
        Catch ex As Exception
            Logger(psIngestionLogFile, "Error In blnGetSummaryReportInfo")
            Logger(psIngestionLogFile, ex.Message)
    ...
    Public Function blnProcessSummaryReportFiles(ByVal sSummaryReportFile As String, ByRef sTotalItemsProcessed As String, ByRef sTotalItemsExported As String, ByRef sTotalItemsSkipped As String, ByRef sTotalItemsFailed As String) As Boolean
        ...
        Try
            ...
            Logger(psIngestionLogFile, "Checking " & sSummaryReportFile & " for items processed.")
            If File.Exists(sSummaryReportFile) Then
                Logger(psIngestionLogFile, "Opening " & sSummaryReportFile & " for processing")
                ...
                End While
            Else
                Logger(psIngestionLogFile, "The summary report file specified at " & sSummaryReportFile & " does not exist")
                blnProcessSummaryReportFiles = False
            End If
            blnProcessSummaryReportFiles = True
        Catch ex As Exception
            MessageBox.Show("Counter = " & iCounter & ": Error in Process Summary Report Files " & ex.ToString)
            Logger(psIngestionLogFile, "Error Checking " & sSummaryReportFile & ex.ToString)
            blnProcessSummaryReportFiles = False
        End Try
    ...
    Public Function blnCheckNuixLogForErrors(ByVal sNuixLogFileDir As String, ByRef sTotalItemsProcessed As String, ByRef sTotalItemsExported As String, ByRef sTotalItemsSkipped As String, ByRef sTotalItemsFailed As String) As Boolean
        ...
        If sNuixLogFile <> vbNullString Then
            Try
                ...
                While Not NuixLogStreamReader.EndOfStream
                    ...
                    If sCurrentRow.Contains("Error running script:") Then
                        Logger(psIngestionLogFile, sNuixLogFile & " - Error " & sCurrentRow)
                    ...
                    ElseIf sCurrentRow.Contains("Total items exported:") Then
                        sTotalItemsExported = sCurrentRow.Replace("Total items exported:", "")
                        Logger(psIngestionLogFile, sNuixLogFile & " - Total Items Exported " & sCurrentRow)
                        blnCheckNuixLogForErrors = False
                    ElseIf sCurrentRow.Contains("Total items skipped:") Then
                        sTotalItemsSkipped = sCurrentRow.Replace("Total items skipped:", "")
                        Logger(psIngestionLogFile, sNuixLogFile & " - Total Items Skipped " & sCurrentRow)
                        blnCheckNuixLogForErrors = False
                    ElseIf sCurrentRow.Contains("Total number of failed items:") Then
                        sTotalItemsFailed = sCurrentRow.Replace("Total number of failed items:", "")
                        Logger(psIngestionLogFile, sNuixLogFile & " - Total Items Failed " & sCurrentRow)
                        blnCheckNuixLogForErrors = False
                    End If
                End While
            ...
            Catch ex As Exception
                ...
                Logger(psIngestionLogFile, "blnCheckNuixLogForErrors - " & ex.ToString)
                blnCheckNuixLogForErrors = False
            End Try
        End If
    ...
    Public Function blnBuildArchiveExtractionBatchFile(ByVal sNuixAppLocation As String, ByVal sArchiveName As String, ByVal sCaseName As String, ByVal sBatchFileName As String, ByVal sNMSSourceType As String, ByVal sNMSAddress As String, ByVal sNMSPort As String, ByVal sNMSUserName As String, ByVal sNMSAdminInfo As String, ByVal sLicenseType As String, ByVal sNumberOfWorkers As String, ByVal sNuixAppMemory As String, ByVal sNuixLogDir As String, ByVal sWorkerTempDir As String, ByVal sRubyFileName As String, ByVal sJavaTempDir As String, ByVal sExportDir As String, ByVal sCNDExportDir As String, ByVal sSQLUserName As String, ByVal sSQLAdminInfo As String, ByVal sServerNameandPort As String, ByVal sCSVMappingFile As String, ByVal sManifestFile As String, ByVal sReportPath As String, ByVal sDBName As String, ByVal sFailOnPartionErrors As String, ByVal sEnableMetadataQuery As String, ByVal sArchiveType As String, ByVal sDocServerID As String, ByVal sSourceFolder As String, ByVal sSisFolder As String, ByVal sFilteredAddressTypes As String, ByVal sFromDate As String, ByVal sToDate As String, ByVal sOutputFormat As String, ByVal sSkipSISIDLookup As String, ByVal sJSonFileName As String, ByVal sExpandDLTo As String, ByVal sCustodianMappingFile As String, ByVal iWorkerTimeout As Integer, ByVal sEVUserList As String, ByVal sPSTExportSize As String, ByVal bPSTAddDistributionListMetadata As Boolean, ByVal bEMLAddDistributionListMetadata As Boolean, ByVal sFileStore As String, ByVal sSQLAuthentication As String, ByVal sSQLDomain As String) As Boolean
        ...
        If sNMSSourceType = "Desktop" Then
            sLicenceSourceType = " -licencesourcetype dongle"
        ElseIf sNMSSourceType = "Server" Then
            sLicenceSourceType = " -licencesourcetype server -licencesourcelocation " & sNMSAddress & ":" & sNMSPort & " -Dnuix.registry.servers=" & sNMSAddress
        ElseIf sNMSSourceType = "Cloud Server" Then
            sLicenceSourceType = " -Dnuix.product.server.addClsProdEndpoint=true -licencesourcetype cloud-server"
        End If
        ...
        ExtractionBatchFile.Write(" -licencetype email-archive-examiner")
        ...
        Select Case sArchiveName
            ...
            Case "HP/Autonomy EAS"
                If sSQLAuthentication = "Windows Authentication" Then
                    ...
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.options=useNTLMv2=" & """" & "useNTLMv2=true" & """")
                ...
                ElseIf sSQLAuthentication = "SQLServer Authentication" Then
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.options=" & """" & "useNTLMv2=false" & """")
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.serverAndPort=" & sServerNameandPort)
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.databaseName=" & sDBName)
                ...
                Else
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.serverAndPort=" & sServerNameandPort)
                    ExtractionBatchFile.Write(" -Dnuix.zant az.databaseName=" & sDBName)
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.userName=" & sSQLUserName)
                    ExtractionBatchFile.Write(" -Dnuix.zantaz.password=" & sSQLAdminInfo)
                End If
            ...
            Case "EMC EmailXtender"
                If sSQLAuthentication = "Windows Authentication" Then
                    ExtractionBatchFile.Write(" -Dnuix.xtender.options=" & """" & "useNTLMv2=true" & """")
                ...
                ElseIf sSQLAuthentication = "SQLServer Authentication" Then
                    ExtractionBatchFile.Write(" -Dnuix.xtender.options=" & """" & "useNTLMv2=false" & """")
                    ExtractionBatchFile.Write(" -Dnuix.xtender.serverAndPort=" & sServerNameandPort)
                    ExtractionBatchFile.Write(" -Dnuix.xtender.databaseName=" & sDBName)
            ...
            Case "Veritas Enterprise Vault"
                If sSQLAuthentication = "Windows Authentication" Then
                    ExtractionBatchFile.Write(" -Dnuix.symantecVault.options=" & """" & "useNTLMv2=true" & """")
                ...
                ElseIf sSQLAuthentication = "SQLServer Authentication" Then
                    ExtractionBatchFile.Write(" -Dnuix.symantecVault.options=" & """" & "useNTLMv2=false" & """")
                    ExtractionBatchFile.Write(" -Dnuix.symantecVault.serverAndPort=" & sServerNameandPort)
                    ExtractionBatchFile.Write(" -Dnuix.symantecVault.databaseName=" & sDBName)
                ...
                ExtractionBatchFile.Write(" -Dnuix.symantecVault.failOnPartitionErrors=false")
                ExtractionBatchFile.Write(" -Dnuix.worker.process.emails.inline=true ")
                ExtractionBatchFile.Write(" -Dnuix.worker.inline.file.threshold=100000000")
                ExtractionBatchFile.Write(" -Dnuix.worker.inlineMimeTypes=application/vnd.symantec-vault,application/vnd.ms-cab-compressed")
    ...
    Public Function blnBuildArchiveEVUserExtractionRuby(ByVal sNuixCaseDir As String, ByVal sCaseName As String, ByVal sNuixFilesDirectory As String, ByVal sRubyFileName As String, ByVal sNumberOfWorkers As String, ByVal sMemoryPerWorker As String, ByVal sSQLiteDBLocation As String, ByVal sNuixConsolePath As String, ByVal sEvidenceJSoN As String, ByVal iEvidenceSize As Double, ByVal sWorkerTempDir As String, ByVal bExtractFromSlackSpace As Boolean, ByVal sSQLAuthentication As String) As Boolean
        ...
        If sSQLAuthentication = "Windows Authentication" Then
            ArchiveEVUserExtraction.WriteLine("url = 'jdbc:jtds:sqlserver://'+" & """" & "#{vaulthost}" & """" & "+';databaseName='+" & """" & "#{$vaultdb1}" & """" & "+';useNTLMv2=true'")
        ElseIf sSQLAuthentication = "SQLServer Authentication" Then
